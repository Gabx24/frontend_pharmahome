...
export default function HamburgerMenu() {
  ...
  return (
    <>
      <Menu styles={styles}>
        <ul> <span onClick={() => setClicked1(!clicked1)}>Medicines</span>
        ...
        <ul> <span onClick={() => setClicked2(!clicked2)}>Cosmetics</span>
          {/* <li className={clicked2 ? "" : "hidden"}><NavLink to="/" >Item1</NavLink></li>
          <li className={clicked2 ? "" : "hidden"}><NavLink to="/" >Item1</NavLink></li>
          <li className={clicked2 ? "" : "hidden"}><NavLink to="/" >Item1</NavLink></li>
          <li className={clicked2 ? "" : "hidden"}><NavLink to="/" >Item1</NavLink></li> */}
        </ul>
        <ul> <span onClick={() => setClicked2(!clicked2)}>Vitamin, Sport & Nutrition</span>
        </ul>
        <ul> <span onClick={() => setClicked2(!clicked2)}>Pregnancy & Meternity</span>
        </ul>
        <ul> <span onClick={() => setClicked2(!clicked2)}>Baby & Child</span>
        </ul>
        <ul> <span onClick={() => setClicked2(!clicked2)}>Over the Counter</span>
        </ul>
